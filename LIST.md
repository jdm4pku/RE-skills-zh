...
|---|-------|------|-------|-------------|
| 1 | [`acceptance-criteria`](skills/acceptance-criteria/SKILL.md) | Component | Specification | Write testable acceptance criteria using Given/When/Then, checklist, and rule-based formats |
| 2 | [`agile-requirements-process`](skills/agile-requirements-process/SKILL.md) | Workflow | Cross-Cutting | Orchestrate RE for agile projects with just-in-time elaboration and continuous validation |
| 3 | [`analysis-advisor`](skills/analysis-advisor/SKILL.md) | Interactive | Analysis | Select the right modeling techniques based on requirement type and system complexity |
| 4 | [`business-rule`](skills/business-rule/SKILL.md) | Component | Foundation | Document business rules as structured, traceable specifications separate from functional requirements |
| 5 | [`change-control-advisor`](skills/change-control-advisor/SKILL.md) | Interactive | Management | Evaluate change requests with impact analysis and scope creep detection |
| 6 | [`change-control-process`](skills/change-control-process/SKILL.md) | Workflow | Management | Establish and operate a change control process with CCB governance |
...
| # | Skill | Phase | Key Techniques |
|---|-------|-------|---------------|
| 1 | `acceptance-criteria` | Specification | Given/When/Then, checklists, rule-based, SMART criteria |
| 2 | `business-rule` | Foundation | 5-type taxonomy, traceability, volatility tracking |
...
Guided decision-making through adaptive questions and context-aware recommendations.

| # | Skill | Phase | Questions | Recommends |
|---|-------|-------|-----------|-----------|
| 1 | `analysis-advisor` | Analysis | 4 questions on req type, complexity, team, concerns | Modeling technique combination |
| 2 | `change-control-advisor` | Management | 4 questions on change type, scope, risk, urgency | Approval/deferral/rejection with rationale |
| 3 | `elicitation-technique-selector` | Elicitation | 4 questions on context, access, info needs, constraints | Elicitation technique from 8 options |
| 4 | `prioritization-advisor-re` | Prioritization | 4 questions on stakeholders, volume, data, context | Prioritization method from 6 options |
| 5 | `prototyping-strategy` | Validation | 4 questions on purpose, fidelity, lifecycle, evaluation | Prototyping approach with evaluation plan |
| 6 | `re-tool-selection` | Cross-Cutting | 4 questions on size, maturity, pain points, integration | Tool strategy with evaluation criteria |
| 7 | `requirements-review-advisor` | Validation | 3 questions on formality, scope, risk | Review method from 4 formality levels |

### Workflow Skills (8)

End-to-end processes orchestrating multiple component and interactive skills.

| # | Skill | Phase | Phases | Skills Orchestrated |
|---|-------|-------|--------|-------------------|
| 1 | `agile-requirements-process` | Cross-Cutting | 5 phases | vision-and-scope, user-story-re, acceptance-criteria, prioritization-advisor-re |
| 2 | `change-control-process` | Management | 5 phases | change-impact-analysis, change-control-advisor, requirements-baselining |
| 3 | `re-process-improvement` | Cross-Cutting | 4 phases | requirements-risk-assessment, specification-review-checklist |
| 4 | `requirements-analysis-process` | Analysis | 6 phases | use-case, process-modeling, data-modeling, state-modeling, decision-table, data-dictionary |
| 5 | `requirements-development-process` | Cross-Cutting | 6 phases | All 29 component + 7 interactive skills (meta-workflow) |
| 6 | `requirements-elicitation-workshop` | Elicitation | 5 phases | elicitation-interview, observation-analysis, questionnaire-design |
| 7 | `requirements-management-process` | Management | 3 phases | requirements-baselining, requirements-status-tracking, requirements-traceability |
| 8 | `requirements-validation-process` | Validation | 5 phases | requirements-review-advisor, requirements-testing, prototyping-strategy |
...
Skills for establishing business requirements and project context.

1. [`vision-and-scope`](skills/vision-and-scope/SKILL.md) — Business objectives, scope, vision statement
2. [`stakeholder-analysis`](skills/stakeholder-analysis/SKILL.md) — Stakeholder identification and classification
3. [`context-diagram`](skills/context-diagram/SKILL.md) — System boundary definition
4. [`business-rule`](skills/business-rule/SKILL.md) — Business rule documentation

### Phase 2: Elicitation (6 skills)
Skills for gathering requirements from stakeholders.

1. [`elicitation-technique-selector`](skills/elicitation-technique-selector/SKILL.md) — Choose the right technique (Interactive)
2. [`elicitation-interview`](skills/elicitation-interview/SKILL.md) — Conduct requirements interviews
3. [`observation-analysis`](skills/observation-analysis/SKILL.md) — Observe users in context
...
1. [`srs-document`](skills/srs-document/SKILL.md) — Software Requirements Specification
2. [`writing-requirements`](skills/writing-requirements/SKILL.md) — Write individual requirements
3. [`quality-attribute`](skills/quality-attribute/SKILL.md) — Non-functional requirements
4. [`data-dictionary`](skills/data-dictionary/SKILL.md) — Data element definitions
5. [`acceptance-criteria`](skills/acceptance-criteria/SKILL.md) — Testable acceptance criteria
6. [`specification-review-checklist`](skills/specification-review-checklist/SKILL.md) — Quality checklist

### Phase 5: Validation (6 skills)
Skills for verifying requirements quality.

1. [`requirements-review-advisor`](skills/requirements-review-advisor/SKILL.md) — Plan reviews (Interactive)
2. [`requirements-testing`](skills/requirements-testing/SKILL.md) — Conceptual testing
3. [`prototyping-strategy`](skills/prototyping-strategy/SKILL.md) — Choose prototyping approach (Interactive)
4. [`specification-review-checklist`](skills/specification-review-checklist/SKILL.md) — Quality checklists
5. [`requirements-validation-process`](skills/requirements-validation-process/SKILL.md) — Full validation workflow (Workflow)

### Phase 6: Prioritization (3 skills)
Skills for ordering requirements by importance.

1. [`prioritization-advisor-re`](skills/prioritization-advisor-re/SKILL.md) — Choose method (Interactive)
2. [`value-cost-risk-analysis`](skills/value-cost-risk-analysis/SKILL.md) — Multi-factor scoring
3. [`moscow-prioritization`](skills/moscow-prioritization/SKILL.md) — MoSCoW categorization

### Phase 7: Management (8 skills)
Skills for ongoing requirements management.

1. [`change-control-advisor`](skills/change-control-advisor/SKILL.md) — Evaluate changes (Interactive)
2. [`change-control-process`](skills/change-control-process/SKILL.md) — Change control workflow (Workflow)
3. [`change-impact-analysis`](skills/change-impact-analysis/SKILL.md) — Impact assessment
4. [`requirements-traceability`](skills/requirements-traceability/SKILL.md) — Traceability matrices
5. [`requirements-baselining`](skills/requirements-baselining/SKILL.md) — Baseline management
6. [`requirements-status-tracking`](skills/requirements-status-tracking/SKILL.md) — Status lifecycle tracking
7. [`requirements-management-process`](skills/requirements-management-process/SKILL.md) — Full management workflow (Workflow)

### Phase 8: Cross-Cutting (7 skills)
Skills spanning the entire RE lifecycle.

1. [`requirements-risk-assessment`](skills/requirements-risk-assessment/SKILL.md) — RE-specific risk management
2. [`requirements-reuse`](skills/requirements-reuse/SKILL.md) — Reuse patterns and catalogs
3. [`re-process-improvement`](skills/re-process-improvement/SKILL.md) — Process improvement cycle (Workflow)
4. [`re-tool-selection`](skills/re-tool-selection/SKILL.md) — Tool evaluation (Interactive)
5. [`requirements-development-process`](skills/requirements-development-process/SKILL.md) — Full development lifecycle (Workflow)
6. [`agile-requirements-process`](skills/agile-requirements-process/SKILL.md) — Agile RE adaptation (Workflow)

---

## Book Chapter Mapping

How skills map to *Software Requirements, Third Edition* chapters:

| Chapter | Topic | Primary Skills |
|---------|-------|---------------|
| Ch 1-2 | Essential Requirements, Customer Perspective | Foundation phase skills |
| Ch 3 | Good Practices for RE | re-process-improvement |
| Ch 4 | The Business Analyst | stakeholder-analysis |
| Ch 5 | Establishing Business Requirements | vision-and-scope, context-diagram |
| Ch 6 | Finding the Voice of the User | stakeholder-analysis, elicitation-technique-selector |
| Ch 7 | Requirements Elicitation | elicitation-interview, observation-analysis, questionnaire-design, requirements-elicitation-workshop |
| Ch 8 | Understanding User Requirements | use-case, user-story-re |
| Ch 9 | Playing by the Rules | business-rule |
| Ch 10 | Documenting Requirements | srs-document |
| Ch 11 | Writing Excellent Requirements | writing-requirements |
| Ch 12 | A Picture Is Worth 1024 Words | process-modeling, state-modeling, decision-table, dialog-map, context-diagram |
| Ch 13 | Specifying Data Requirements | data-dictionary, data-modeling |
| Ch 14 | Beyond Functionality | quality-attribute |
| Ch 15 | Risk Reduction Through Prototyping | prototyping-strategy |
| Ch 16 | Setting Requirement Priorities | prioritization-advisor-re, value-cost-risk-analysis, moscow-prioritization |
| Ch 17 | Validating Requirements | requirements-review-advisor, requirements-testing, specification-review-checklist, requirements-validation-process |
| Ch 18 | Requirements Reuse | requirements-reuse |
| Ch 20 | Agile Projects | agile-requirements-process, user-story-re |
| Ch 27 | Requirements Management Practices | requirements-baselining, requirements-status-tracking, requirements-management-process |
| Ch 28 | Change Happens | change-control-advisor, change-control-process, change-impact-analysis |
| Ch 29 | Links in the Requirements Chain | requirements-traceability |
| Ch 30 | Tools for Requirements Engineering | re-tool-selection |
| Ch 31 | Improving Your Requirements Processes | re-process-improvement |
| Ch 32 | Software Requirements and Risk Management | requirements-risk-assessment |
